...
def process_song_file(cur, filepath):
     ...
     """
    - Gathers data from song JSON file.
...
def process_log_file(cur, filepath):
     ...
     """
    - Gathers data from log JSON file; filters by NextSong action.
    - Converts timestamp column to datetime.
    - Inserts time data, user and songplay records.
    """
    # open log file
...
def process_data(cur, conn, filepath, func):
     """
    - Function to process all music data files and respective functions. 
    """
